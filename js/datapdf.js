  ...
  function me_data1() { 
   ...
   co_a_text += "<br><div >"+$('#course_name_a_'+i).val()+": " +parseInt($('#num_hours_'+i).autoNumeric('get'))+" Weeks  </div>" 
      }
   ...
   function ce_data1(){
    ...
    {
        ce_text += "<br><div>CLEP and DANTES Credit Hours Earned: "+ parseInt($('#num_credit_hours').autoNumeric('get')) +"</div>";
    }
    r=0;
    if($('#ca_text_1').val() !="")
    {
